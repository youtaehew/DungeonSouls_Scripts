...
public class AttackState : State
{
    ...
    IEnumerator CheckEndAttack(EnemyAnimatonManager enemyAniamtor,EnemyManager enemyManager)
    {
        yield return new WaitForSeconds(enemyAniamtor.ani.GetCurrentAnimatorClipInfo(0).Length);
